...
get_header( ); ?>
	...
	<div class="container">
		...
		<section class="contents" id="order">
			...
			<div class="sixcol col" id="features">
				<h4>WEB見積は便利でお得！</h4>
				<ul>
					<li>見積がWEBで完結</li>
					<li>あっというまの3ステップ</li>
				...
				<div id="merits">
					<p><span class="pink b big">100名限定</span>のお試しキャンペーン中！<br />WEB見積からお申込みの方のみ、<br /><span class="big b">基本料金(3,240円)が<span class="b pink big">無料！</span></span></span></p>
				</div>
				<div id="attention">
