	...
	<div class="container">
		...
		<aside class="twocol col last" id="shortcuts">
			...
			<ul class="listBtn">
				...
				<li>
					<a href="tel:0120530<?php echo telNum("", pageCode(), ""); ?>" id="tel">
						<span class="icon-phone"></span>
						<span class="indexTitle">0120<span class="block">530-<?php echo telNum("", pageCode(), ""); ?></span></span>
					</a>
				</li>
			</ul>
		<!-- #shorcuts--></aside>
		...
		<div class="liquidLayout">
			...
			<section class="fourcol col" id="faq">
			...
			<section class="fourcol col" id="voices">
				<div class="colContents">
					<h3>お客様の声</h3>
					<h4>受付スタッフについて</h4>
					<ul>
						<li>
							<p class="voicesInfo">神奈川県 20代 男性 </p>
						...
						<li>
							<p class="voicesInfo">千葉県 30代 女性 </p>
					...
					<ul>
						...
						<li>
							<p class="voicesInfo">東京都 40代 男性</p>
			...
			<section class="fourcol col" id="news">
				<div class="colContents">
					<h3>新着情報&お知らせ</h3>
					<ul class="news">
					<?php
			...
			<div class="col fourcol webservices" id="movie">
			...
			<div class="col fourcol webservices" id="twitter">
			...
			<div class="col fourcol webservices" id="facebook">
			...
			<!--配車カレンダー
			<section id="reservCalendar" class="fourcol col">
				<div id="contentsCalendar" class="colContents">
					<h3>予約状況</h3>
					<ul>
